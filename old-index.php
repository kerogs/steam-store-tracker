            ...
            <tbody>
                ...
                foreach ($items as $itemInventory) {
                    if ($itemInventory == '.' || $itemInventory == "..") {
                        ...
                        echo '<td><button class="red" data-settings="item-delete" data-reload="true" data-id="' . $itemInventoryName['filename'] . '">DELETE</button> <button data-settings="item-refresh" data-id="'.$itemData['itemID'].'" class="blue">REFRESH</button> <button data-settings="item-graphic" data-id="'.$itemData['itemID'].'" class="blue">GRAPHIC</button></td>  ';
                        echo '</tr>';
